...
exports.connect = function(callback) {
  var db = new mongo.Db(process.env["MONGO_DATABASE"], new mongo.Server(process.env["MONGO_SERVER"], parseInt(process.env["MONGO_PORT"]), {}))
  db.open(function(error, db) {
    if (error) return
    db.authenticate(process.env["MONGO_USER"], process.env["MONGO_PASSWORD"], function(error, replies) {
